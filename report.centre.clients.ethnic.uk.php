			...
			<div class="row">
				...
				<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
						<h1 class="h2"><i class="fas fa-chart-pie"></i> Ethnic Breakdown of UK Resident Clients Using Centre</h1>
					</div>
					<div class="card">
					...
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-striped table-sm table-fixed" id="report_table">
							</table>
						</div>
					</div>
					<br>
...
  					event.preventDefault();
			...
			function submit_query() {
				...
				$.post("ajax/report.centre.clients.ethnic.uk.php", {
