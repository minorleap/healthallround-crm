					...
					<div class="card">
						<h5 class="card-header">
							<div class="row align-items-center">
								<div class="col"><i class="fas fa-tasks"></i> Active Activities</div>
							</div>
						</h5>
						<div class="card-body">
						...
						<div class="card-footer text-muted">	
							<a href="activity.new.php" class="btn btn-primary"><i class='fas fa-plus'></i> New Activity</a>
							<a href="activities.archived.php" class="btn btn-warning"><i class='fas fa-archive'></i> Archived Activities</a>
						</div>
					</div>	
				</main>
			</div>
