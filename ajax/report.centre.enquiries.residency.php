...
$sql = "
	SELECT `residency_status_description`,
	...
	FROM (
		...
		`view_clients`.`residency_status_description`,
...
while($row = $result->fetch_assoc()){
	...
	$residency_statuses[$residency_status_description] = ['enquiries' => $number_of_enquiries, 'visits' => $number_of_visits];
}


foreach($residency_statuses as $status=>$values) {
