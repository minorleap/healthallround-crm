...
$columns = array(
    array( 'db' => 'id', 'dt' => 0),
	array( 'db' => 'assessment_date', 'dt' => 1, 'formatter' => function($d, $row) {
		return $d? date('d/m/Y', strtotime($d)) : "";
	}),	
	array( 'db' => 'type', 'dt' => 2),	
	array( 'db' => 'total_score', 'dt' => 3),
	array( 'db' => 'questions_completed', 'dt' => 4),	
	array( 'db' => 'mean_score', 'dt' => 5),
	array( 'db' => 'clinical_score', 'dt' => 6),
