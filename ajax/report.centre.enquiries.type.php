...
$sql = "
	SELECT `enquiry_type_description`,
	...
	GROUP BY `enquiry_type_description`;
";
...
$result = $conn->query($sql);
	while($row = $result->fetch_assoc()){
		...
		$enquiry_types[$enquiry_type_description] = ['enquiries' => $number_of_enquiries, 'visits' => $number_of_visits];
	}

foreach($enquiry_types as $type=>$values) {
