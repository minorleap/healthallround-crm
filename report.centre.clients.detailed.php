			...
			<div class="row">
				...
				<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
						<h1 class="h2"><i class="fas fa-chart-pie"></i> Number of Clients Using Centre (Detailed)</h1>
					</div>
					<div class="card">
						...
						<div class="card-body">
							<div class="row">								
								<div class="col-2">
									...
									<br>
									<button type="submit" id="submit_btn" class="btn btn-large btn-primary"><i class="fas fa-download"></i> Download</button>
								</div>
								<div class="col-2">
									<h6>End Date</h6>
...
  					event.preventDefault();
			...
			function submit_query() {
				...
				$.post("ajax/report.centre.clients.detailed.php", {
