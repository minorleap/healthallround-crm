...
<?php $pageTitle = "Report: Types of Enquiries Breakdown"; ?>
<!doctype html>
<html lang="en">
	<head>
		<meta charset="utf-8">
					...
					<div class="card">
						<div class="card-header">
							...
							<form role="form">
								...
								<button type="submit" id="submit_btn" class="btn btn-large">Submit</button>
							</form>						
						</div>
						<div class="card-body">
...
  					event.preventDefault();
			...
			function submit_query() {
				...
				$.post("ajax/report.centre.enquiries.type.php", {
